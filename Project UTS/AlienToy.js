...
function main() {
    ...
    // Create buffers head
    //==============================================================================================
    var head = generateHead(0, 0, 0.5, 1.2, 50, 1.5, 1, 1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    // Create buffers eye
    //==============================================================================================
    var eyeMid = generateEye(0, 0.3, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var eyeRight = generateEye(0.8, 0.1, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var eyeLeft = generateEye(-0.8, 0.1, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //pupil
    var pupilMid = generatePupil(0, 0.35, 1.71, 2, 50, 0.1, 0.1, 0.08); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pupilRight = generatePupil(0.8, 0.15, 1.7, 2, 50, 0.1, 0.1, 0.09); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pupilLeft = generatePupil(-0.8, 0.15, 1.7, 2, 50, 0.1, 0.1, 0.09); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //hiasan
    var hiasanMid = generateHiasanEye(0.07, 0.4, 1.85, 2, 50, 0.02, 0.02, 0.01); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var hiasanRight = generateHiasanEye(0.85, 0.20, 1.86, 2, 50, 0.02, 0.02, 0.01); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var hiasanLeft = generateHiasanEye(-0.75, 0.20, 1.86, 2, 50, 0.02, 0.02, 0.01); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //==============================================================================================
    var kelopakMid = generateKelopak(0, 0.3, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var kelopakRight = generateKelopak(0.8, 0.1, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var kelopakLeft = generateKelopak(-0.8, 0.1, 1.45, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //anten
    var anten1 = generateAnten(1, 1, 1, 2, 4, 100, 0.2, 0.2, 0.2, 1, 1, 1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
