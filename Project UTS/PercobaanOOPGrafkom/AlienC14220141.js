...
//Kepala
//==========================================================================================
function generateHead(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
...
//Mata
//==========================================================================================
function generateEye(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//pupil
function generatePupil(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//hiasan
function generateHiasanEye(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//Kelopak
//==========================================================================================
function generateKelopak(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//anten
function generateAnten(x, y, z, radius, height, segments, tabScaleX, tabScaleY, tabScaleZ, rotationX, rotationY, rotationZ) {
    var vertices = [];
    var colors = [];
...
//hiasan badan
function generatePelengkapBadan(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//leher 
function generateLeher(x, y, z, radius, height, segments, tabScaleX, tabScaleY, tabScaleZ, rotationX, rotationY, rotationZ) {
    var vertices = [];
    var colors = [];
...
//badan
function generateBadan(x, y, z, radius, height, segments, tabScaleX, tabScaleY, tabScaleZ, rotationX, rotationY, rotationZ) {
    var vertices = [];
    var colors = [];
...
//sendi bola
function generateSendi(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    var vertices = [];
    var colors = [];
    var angleIncrement = (2 * Math.PI) / segments;
    var rainbowColors = [
...
//pinggul
// function generatePinggul(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
//     var vertices = [];
//     var colors = [];
//     var angleIncrement = (2 * Math.PI) / segments;
//     var rainbowColors = [
...
//tangan kaki 
function generateTanganKaki(x, y, z, radius, height, segments, tabScaleX, tabScaleY, tabScaleZ, rotationX, rotationY, rotationZ) {
    var vertices = [];
    var colors = [];
...
function main() {
    ...
    // Create buffers head
    //==============================================================================================
    var head = generateHead(0, 0, 0, 1.2, 50, 1.5, 1, 1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    // Create buffers eye
    //==============================================================================================
    var eyeMid = generateEye(0, 0, 2.2, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var eyeRight = generateEye(1.2, 0, 1.9, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var eyeLeft = generateEye(-1.2, 0, 1.9, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pupilMid = generatePupil(0, -0.35, 2.2, 2, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pupilRight = generatePupil(1.2, -0.35, 1.95, 2, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pupilLeft = generatePupil(-1.2, -0.35, 1.95, 2, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //hiasan
    var hiasanMid = generateHiasanEye(0.05, -0.40, 2.25, 1, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var hiasanRight = generateHiasanEye(1.25, -0.4, 2, 1, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var hiasanLeft = generateHiasanEye(-1.15, -0.4, 2, 1, 50, 0.1, 0.05, 0.1); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //==============================================================================================
    var kelopakMid = generateKelopak(0, 0, 2.2, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var kelopakRight = generateKelopak(1.2, 0, 1.9, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var kelopakLeft = generateKelopak(-1.2, 0, 1.9, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //anten
    var anten1 = generateAnten(0, 0, 1.8, 1.5, 0.5, 50, 0.05, 0.05, 0.05, 0, Math.PI, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var anten2 = generateAnten(0.8, 0, 1, 1.5, 0.5, 50, 0.05, 0.05, 0.05, 0, -Math.PI/7, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var anten3 = generateAnten(-0.8, 0, 1, 1.5, 0.5, 50, 0.05, 0.05, 0.05, 0, Math.PI/7, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //leher
    var leher = generateLeher(0, 0, -1.95, 2.8, 0.3, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //Pelengkap badan
    var pbadan = generatePelengkapBadan(0, 0, -2.4, 1.5, 50, 1, 1, 0.4); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    var pbadan1 = generatePelengkapBadan(0, 0, -4.8, 1.5, 50, 1, 1, 0.4); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //badan
    var badan = generateBadan(0, 0, -4.8, 1.20, 2, 50, 1, 1, 0, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //sendi
    //KANAN
    var sendikanan = generateSendi(1.7, 0, -2.6, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //LVL2
    var sendikanan2 = generateSendi(1.7, 0, -4.2, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //KANAN BAWAH
    var sendikananbawah = generateSendi(1.2, 0, -5.4, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //LVL2
    var sendikananbawah2 = generateSendi(1.2, 0, -7, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //KIRI
    var sendikiri = generateSendi(-1.7, 0, -2.6, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //LVL2
    var sendikiri2 = generateSendi(-1.7, 0, -4.2, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //KIRI BAWAH
    var sendikiribawah = generateSendi(-1.2, 0, -5.4, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //LVL 2
    var sendikiribawah2 = generateSendi(-1.2, 0, -7, 2, 50, 0.2, 0.2, 0.2); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //==============================================================================================
    //TANGANkanan
    var tangankanan = generateTanganKaki(1.7, 0, -4.2, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //TANGANkiri
    var tangankiri = generateTanganKaki(-1.7, 0, -4.2, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //kaki kanan
    var kakikanan = generateTanganKaki(1.2, 0, -7, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //kaki kiri
    var kakikiri = generateTanganKaki(-1.2, 0, -7, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //lvl2
    //TANGANkanan
    var tangankanan2 = generateTanganKaki(1.7, 0, -5.9, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //TANGANkiri
    var tangankiri2 = generateTanganKaki(-1.7, 0, -5.9, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //kaki kanan
    var kakikanan2 = generateTanganKaki(1.2, 0, -8.7, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    //kaki kiri
    var kakikiri2 = generateTanganKaki(-1.2, 0, -8.7, 2.8, 0.6, 50, 0.05, 0.05, 0.05, 0, 0, 0); // x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
